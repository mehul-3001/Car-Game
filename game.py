...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Mehul Bokdia')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Mehul Bokdia", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("mehulbokdia3001@gmail.com", True, self.white)
